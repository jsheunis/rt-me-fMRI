...
options.roi_orig_dir = '/Users/jheunis/Desktop/NEUFEPME_data_templates';
options.roi = struct;
...
options.roi.emotionProcessing.orig_fn = {fullfile(options.roi_orig_dir, 'Fusiform_Gyrus_allregions.nii')}; % Raw ROI filenames

options.roi.emotionProcessing.name = {'Bilateral Fusiform Gyrus'}; % For plots and strings
options.roi.emotionProcessing.desc = {'fusiformGyrus'}; % For BIDS file naming (after normalisation  to functional space)
